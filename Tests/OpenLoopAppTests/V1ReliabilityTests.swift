...
struct V1ReliabilityTests {
    ...
    @Test func nativeWorkspaceGeometryKeepsOneCalmSpaciousVisualRhythm() {
        ...
        #expect(OpenLoopVisualSystem.taskRowMinimumHeight == 56)
        #expect(OpenLoopVisualSystem.sidebarSelectionRadius == 10)
        ...
        #expect(OpenLoopVisualSystem.contentTopPadding == 68)
        #expect(OpenLoopVisualSystem.contentBottomPadding == 92)
        #expect(OpenLoopVisualSystem.contentHorizontalPadding == 48)
