...
struct V1ReliabilityTests {
    ...
    @Test func workspaceOrientationMakesNavigationAndCaptureShortcutsExplicit() {
        ...
        #expect(WorkspaceOrientation.meetingRecordShortcut.contains("⌃⌥R"))
    ...
    @Test func nativeWorkspaceGeometryKeepsOneCalmSpaciousVisualRhythm() {
        ...
        #expect(OpenLoopVisualSystem.contentMaximumWidth == 820)
        #expect(OpenLoopVisualSystem.checkboxSize == 18)
        #expect(OpenLoopVisualSystem.checkboxHitSize == 28)
        #expect(OpenLoopVisualSystem.taskRowMinimumHeight == 60)
        #expect(OpenLoopVisualSystem.sidebarSelectionRadius == 8)
        #expect(OpenLoopVisualSystem.inputRadius == 12)
        #expect(OpenLoopVisualSystem.editorRadius == 14)
        #expect(OpenLoopVisualSystem.panelRadius == 14)
        #expect(OpenLoopVisualSystem.contentTopPadding == 58)
        #expect(OpenLoopVisualSystem.contentBottomPadding == 154)
        #expect(OpenLoopVisualSystem.contentHorizontalPadding == 56)
