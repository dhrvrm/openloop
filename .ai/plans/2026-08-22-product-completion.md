...
- [x] **Step 1: Add a failing development-to-release key migration test**
...
- [x] **Step 2: Compose the migration-safe provider**
...
- [x] **Step 3: Make retention copy truthful**
...
- [x] **Step 1: Add a gated model-preparation test**
...
- [x] **Step 2: Reverse the startup dependency**
...
- [x] **Step 3: Coalesce partial inference**
...
- [x] **Step 4: Verify timing behavior**
...
- [x] **Step 1: Replace the legacy controller dependency**
...
- [x] **Step 2: Add deterministic HUD visibility rules**
...
- [x] **Step 3: Add a Transcripts destination**
...
- [x] **Step 4: Remove duplicate voice presentation code**
...
- [x] **Step 5: Verify without launching the GUI**
...
- [x] **Step 1: Add long-form and short-switch failures**
...
- [x] **Step 2: Segment all durations**
...
- [x] **Step 3: Expand ensemble risk detection**
...
- [x] **Step 4: Make disagreement user-visible or fused**
...
- [x] **Step 1: Define versioned interpretation records**
...
- [x] **Step 2: Add local structured extraction with validation**
...
- [x] **Step 3: Extract multiple semantic objects per utterance**
...
- [x] **Step 5: Upgrade Ask and Emerging**
...
- [x] **Step 5: Reconcile the visual source of truth**
...
- [x] **Step 1: Persist Observe/Suggest/Act grants**
...
- [x] **Step 2: Discover and normalize MCP tools**
...
- [x] **Step 3: Prepare before acting**
...
- [x] **Step 4: Add audit and recovery**
...
- [x] **Step 2: Make marketing controls truthful**
...
- [x] **Step 3: Finish accessibility and metadata**
...
- [x] **Step 4: Add stable signed release inputs**
